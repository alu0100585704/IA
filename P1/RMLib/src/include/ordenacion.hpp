...
void insertar(vector_t<matricula_t> & secuencia, matricula_t x,int i)
{
    ...
    while (x>secuencia[j]) 
    {
        ...
        if (paso_a_paso) {
                        tecla();
                        cout <<"Posicion " << j << " : " << secuencia[j].get_set() << endl;
                        }
    }
...
void f_ordenacion_insercion(vector_t<matricula_t> & secuencia,int tamano)
{
   ...
   {    
       ...
       if (paso_a_paso) {
       cout << " ----------------------------------------------------------" << endl;
       cout << "Comparando : " << secuencia[i].get_set() << " en posicion " << i << " con : " << endl << "Posicion " << 0 << " : " << secuencia[0].get_set() << endl;
  ...
  for (int i=0; i < (tamano-1); i++) 
   {    
            ...
            { 
                       if (paso_a_paso) {
                                cout << " ----------------------------------------------------------" << endl;
                                cout << "Comparando : " << secuencia[j].get_set() << " en posicion " << j << " con : " << endl << "Posicion " << minimo << " : " << secuencia[minimo].get_set() << endl;
  ...
  while ((inicio < fin)  && (cambios==true))
  {
      ...
      //igual que metodo de la burguja
        for (int j = fin; j >= inicio; j--)
        {
                       if (paso_a_paso) {
                                cout << " ----------------------------------------------------------" << endl;
                                cout << "Comparando : " << secuencia[j].get_set() << " en posicion " << j << " con : " << endl << "Posicion " << j-1 << " : " << secuencia[j-1].get_set() << endl;
...
pivote= secuencia[(i+f)/2];
    ...
    do{ 
                    if (paso_a_paso) {
                                cout << " ----------------------------------------------------------" << endl;
                                cout << "Comparando : " << secuencia[i].get_set() << " en posicion " << i << " si es MENOR que Pivote : " << pivote.get_set() << endl;
        ...
        { 
            i++;
                    ...
                    if (paso_a_paso) {
                                cout << " ----------------------------------------------------------" << endl;
                                cout << "Comparando : " << secuencia[f].get_set() << " en posicion " << f << " si es MAYOR que Pivote : "  << pivote.get_set() << endl;
                                   }
...
void shellsort(vector_t<matricula_t> &secuencia,int delta, int tamano)
{
 ...
 int i,j;
    ...
    if (paso_a_paso) {
                        cout << " ----------------------------------------------------------" << endl;
                        //cout << "Comparando : " << secuencia[j-delta].get_set() << " en posicion " << j-delta << " si es MAYOR que : "  << aux.get_set() << endl;
                    }            
